		...
		<Table.Row onClick={() => gotoItem(item.id)}>
			<div className='cursor-pointer'>
				<SearchTermMarker
					...
					textToDisplay={item.hbcNumber}></SearchTermMarker>
			</div>
			<div className='cursor-pointer'>
				<SearchTermMarker
					textToFind={searchTerm || ""}
					textToDisplay={item.itemType}></SearchTermMarker>
			</div>
			<div className='cursor-pointer'>
				<SearchTermMarker
					textToFind={searchTerm || ""}
					textToDisplay={item.serialNumber}></SearchTermMarker>
			</div>
			<div className='cursor-pointer'>
				<SearchTermMarker
					textToFind={searchTerm || ""}
					textToDisplay={item.description}></SearchTermMarker>
			</div>
			<div className='cursor-pointer'>
				<SearchTermMarker
					textToFind={searchTerm || ""}
					textToDisplay={item.computerName}></SearchTermMarker>
			</div>
			...
			<div
				...
				{item.assignedTo && (
					<div>
						<SearchTermMarker
							textToFind={searchTerm || ""}
							textToDisplay={item.assignedTo}></SearchTermMarker>
					</div>
				)}
			</div>
